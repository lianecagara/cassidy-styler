...
__export(index_exports, {
  ...
  line: () => line,
  normalizeFormatOverloads: () => normalizeFormatOverloads,
...
((Datum2) => {
  function readPackageJson(pkgPath = "./package.json") {
    return __async(this, null, function* () {
      try {
        const data = yield import_promises.default.readFile(pkgPath, "utf-8");
  ...
  function updatePackageJson(pkgPath, updater) {
    return __async(this, null, function* () {
      ...
      yield import_promises.default.writeFile(pkgPath, JSON.stringify(updated, null, 2));
    });
  }
